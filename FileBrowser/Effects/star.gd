...
func set_star(star_points, radius, inner_radius, star_color: Color=Color.YELLOW, outline_width:float = 0.0, outline_color: Color=Color.BLACK):
	if outline_width > 0:
